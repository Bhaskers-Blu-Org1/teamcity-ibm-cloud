...
public class IBMDeleteCloudImageController extends BaseController {

	private PluginDescriptor myDescriptor;
	private CloudManagerBase myCloudManager;

	public IBMDeleteCloudImageController( @NotNull final WebControllerManager manager, @NotNull final PluginDescriptor descriptor, @NotNull final CloudManagerBase cloudManager) {
